...
import { useIsForeground } from './components/hooks';
...
type Props = NativeStackScreenProps<any, 'CameraScreen'>;
function CameraScreen({ navigation }: Props): React.ReactElement {
